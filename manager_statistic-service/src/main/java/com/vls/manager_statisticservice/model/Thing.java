...
public class Thing {
    ...
    public Thing(UUID id, String thing_name, String origin, int price, int quantity, String used_time,
                 String image, UUID user_id, UUID post_id) {
        this.id = id;
    ...
    public Thing(String thing_name, String origin, int price, int quantity, String used_time, String image, UUID user_id, UUID post_id) {
        this.thing_name = thing_name;
        this.origin = origin;
        this.price = price;
        this.quantity = quantity;
