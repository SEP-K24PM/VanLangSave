...
public class PostReportDTO {
    ...
    public PostReportDTO(UUID id, String description, String reason_by_admin, String handling, UUID post_id, UUID reporter_id, UUID admin_id, PostDTO post, UserAccountDTO reporter, AdminAccountDTO admin) {
        this.id = id;
    ...
    public PostReportDTO(String description, String reason_by_admin, String handling, UUID post_id, UUID reporter_id, UUID admin_id, PostDTO post, UserAccountDTO reporter, AdminAccountDTO admin) {
        this.description = description;
        this.reason_by_admin = reason_by_admin;
        this.handling = handling;
        this.post_id = post_id;
