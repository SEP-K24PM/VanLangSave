...
public class Post {
    ...
    public Post(UUID id, String description, String exchange_methods, Date created_time, Thing thing) {
        this.id = id;
    ...
    public Post(String description, String exchange_methods, Date created_time, Thing thing) {
        this.description = description;
        this.exchange_methods = exchange_methods;
        this.created_time = created_time;
        this.thing = thing;
